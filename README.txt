...
find-contributors.sh ---------------------------------------- <no recording yet>
    ...
    standard") since GitHub started recognising it in 2017 to credit multiple
    authors for a commit.
...
edit-service-groups.sh ------- https://asciinema.org/a/ms9qxEUyvH2onWnUJPOUuNoAg
    ...
    Conveniently and visually grep through a two-dimensional (service × env)
    collection of service groups in a gigantic yaml file, edit a finely scoped
    partial view of it, and have it automagically merged back cleanly into the
    original document.  Behaves well even if your configuration entries are
    thousands of lines apart.  Implemented as a single command since 3bc59d6.
